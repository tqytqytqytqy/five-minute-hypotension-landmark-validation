...
- `results/aggregate_source_data/`: 19 non-patient-level CSV files and their source-data README, used to reproduce the submitted tables and figures.
- `results/figures/`: five programmatically generated figures in PDF and PNG formats.
